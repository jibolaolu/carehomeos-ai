      ...
      <div className="chartGrid">
        ...
        <div className="card">
          ...
          <ol style={{ paddingLeft: 18, display: "grid", gap: 10, fontSize: 13, lineHeight: 1.6 }}>
            ...
            <li>
              Include the token in the <code>Authorization: Bearer {"<token>"}</code> header, or use{" "}
              <code>X-API-Key</code> for the public API.
            </li>
            <li>
              Explore endpoints at{" "}
              <a href="/developer/docs" style={{ color: "var(--brand)" }}>
                API docs
              </a>
              .
            </li>
            <li>
              Configure{" "}
              <a href="/developer/webhooks" style={{ color: "var(--brand)" }}>
                webhooks
              </a>{" "}
